...
# Crearea unei tabele care sa stocheze toate informatiile despre cartile din librarie
...
# Crearea unei tabele care sa stocheze toate informatiile despre clientii librariei
...
# Crearea unei tabele care sa stocheze toate informatiile despre comenzile librariei
...
# Crearea unei tabele de legatura intre tabela carti si tabela comenzi
...
# Crearea unei tabele de legatura intre tabela comenzi si tabela clienti
...
# Crearea unei tabele care sa stocheze modalitatile de plata
...
# Crearea unei tabele care sa stocheze date despre livrare
...
# Instructiuni DML = Data Manipulation Language
...
# Dezactivare SAFE UPDATE MODE pentru a putea sterge un rand

SET SQL_SAFE_UPDATES=0;

# Stergere rand din tabela CARTI
...
INSERT INTO CLIENTI VALUES (21, 'Zamfiroiu', 'Alina', 'Str. 11 iunie', 'Bucuresti', '0745258369'),
                           (22, 'Badea', 'George', 'Str. Albatrosului, Sector 2', 'Bucuresti', '0745789456'),
                           (23, 'Erhan', 'Mihaela', 'Aleea Dealul Mitropoliei nr 9', 'Bucuresti', '0744521478'),
                           (24, 'Predescu', 'Gabriela', 'Str. I.C. Bratianu nr 3', 'Rm. Valcea', '0770258147'),
                           (25, 'Mihalache', 'Adina', 'Str. Mihail Sadoveanu, nr 12', 'Rm. Valcea', '0770741258'),
                           (26, 'Aleman', 'Rodica', 'Aleea Haiducului nr. 40', 'Rm. Valcea', '0722547821'),
                           (27, 'Apostolescu', 'Bogdan', 'Str. Alexe Ion, nr 37', 'Brasov', '0721546321'),
                           (28, 'Georgescu', 'Adriana', 'Str. Aleman nr 17', 'Brasov', '0723568974'),
                           (29, 'Parvulescu', 'Mihaela', 'Str. Rapsodiei nr 15', 'Brasov', '0766325748'),
                           (30, 'Popianu', 'Mihaela', 'Str. Aurel Vlaicu nr 9', 'Brasov', '0729335874');
...
# Actualizare tabela CLIENTI

UPDATE CLIENTI
SET NUME='MIRON'
WHERE ID_CLIENT=15;

# Actualizare tabela CARTI

UPDATE CARTI
SET PRET='40'
WHERE ID_CARTE=14;

# Actualizare tabela CARTI_COMANDATE

UPDATE CARTI_COMANDATE
SET CANTITATE='2'
WHERE ID_COMANDA=2 AND ID_CARTE=3;  

# Stergere rand din tabela CLIENTI
...
# Returnarea cartilor din categoria IT, ordonate descrescator cu limita 5 pretului maxim al cartilor
...
# Adaugare valori in tabela PLATA
...
ALTER TABLE CLIENTI ADD COLUMN ID_COMANDA INT;
ALTER TABLE CLIENTI ADD foreign key(ID_COMANDA) references COMENZI(ID_COMANDA);
