...
<ul>
  ...
  <li> comenzi  is connected with carti_comandate through a **ONE TO MANY** relationship which was implemented through **ORDERS.ORDERS_ID** as a primary key and **ORDERED.BOOKS.ORDERS_ID** as a foreign key</li>
